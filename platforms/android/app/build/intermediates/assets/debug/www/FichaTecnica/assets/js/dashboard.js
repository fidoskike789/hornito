	...
	else
	{
		...
		$.ajax({
		    ...
		    success: function(resp) {
		    	...
		    	$("#chartPen").attr("data-percent", ((isNaN(pPendientes)) ? 0 : pPendientes));
		    	$("#chartPro").attr("data-percent", ((isNaN(pProcesando)) ? 0 : pProcesando));
		    	$("#chartFin").attr("data-percent", ((isNaN(pFinalizadas)) ? 0 : pFinalizadas));
