                ...
                if(data.length > 0){
                    ...
                    $.each(data, function (i, d) {
                        if(idOM != d.idOrdenMantenimiento){
                            ...
                            //var table = "&nbsp;";
                            var tblTrabajos = "<table border='0' style='font-size: 11px'>"
                            var tblNovedades = "<table border='0' style='font-size: 11px'>"
                                           /*+ "<tr>"
                            ...
                            $.each(data, function (j, item) {
                                ...
                                {
                                    if(item.idTipoActividad == 1) //trabajos
                                    {
                                        tblTrabajos += "<tr>"
                                    ...
                                    if(item.idTipoActividad == 2) //novedades
                                    {
                                        tblNovedades += "<tr>"
                                                        //+ "<td><b>" + ((item.idTipoActividad == 1) ? "Trabajo:" : "Novedad") + "</b></td>"
                                                        + "<td>" + item.descripcion + "</td>"
